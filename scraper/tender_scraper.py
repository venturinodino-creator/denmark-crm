...
Denmark's national portal (udbud.dk) is an Angular SPA with no public JSON
API, so it is not scraped. Verified 2026-09-12: none of the obvious
/api/* paths return JSON. Below-EU-threshold Danish notices are therefore
out of reach for now — a real coverage gap worth revisiting.
...
CATEGORY_KEYWORDS = [
    ...
    # CRIS / databases — Danish
    "forskningsinformationssystem", "forskningsinformation",
    "forskningsregistrering", "forskningsdatabase",
    "publikationsdatabase", "forskningsportal",
    "videnskabelige databaser", "litteraturdatabaser",
    "bibliometrisk", "bibliometri",
]
...
PRODUCT_ALIGNMENT = {
    ...
    "openalex": "Scopus",
    # ── Danish ──
    "forskningsinformationssystem": "Elsevier Pure",
    "forskningsinformation": "Elsevier Pure",
    "forskningsregistrering": "Elsevier Pure",
    "forskningsdatabase": "Elsevier Pure",
    "publikationsdatabase": "Elsevier Pure",
    "forskningsportal": "Elsevier Pure",
    "bibliometrisk": "SciVal",
    "bibliometri": "SciVal",
...
CRIS_MARKERS = [
    ...
    "forskningsinformationssystem", "forskningsinformation",
    "forskningsregistrering", "forskningsportal",
]
