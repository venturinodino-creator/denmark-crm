 ...
 *
 * What it looks for. Evidence that a Denmark research institution has
...
const NATIONAL_HINTS = 'the Royal Danish Library (Det Kgl. Bibliotek), the Danish Agency for Higher Education and Science and its DEFF licence consortium, DeiC, Universities Denmark (Danske Universiteter), the National Open Research Analytics (NORA) research portal, Independent Research Fund Denmark, the Novo Nordisk Foundation, the Danish Open Access Indicator';
