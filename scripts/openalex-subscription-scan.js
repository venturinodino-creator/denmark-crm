 ...
 * Board notes — that a Denmark research institution has subscribed to OpenAlex
...
// The Denmark institutions this CRM tracks — kept in sync with SEED_INSTITUTIONS
...
const DK_INSTITUTIONS = [
  'University of Copenhagen (UCPH)', 'Aarhus University (AU)',
  'Technical University of Denmark (DTU)', 'University of Southern Denmark (SDU)',
  'Aalborg University (AAU)', 'Copenhagen Business School (CBS)', 'Roskilde University (RUC)',
  'IT University of Copenhagen (ITU)',
  'Rigshospitalet (Copenhagen University Hospital) (Rigshospitalet)',
  'Aarhus University Hospital (AUH)', 'Odense University Hospital (OUH)',
  'Copenhagen University Hospital – Herlev and Gentofte (Herlev-Gentofte)',
  'Aalborg University Hospital (AaUH)',
  'Copenhagen University Hospital – Bispebjerg and Frederiksberg (Bispebjerg-Frederiksberg)',
  'Copenhagen University Hospital – Amager and Hvidovre (Amager-Hvidovre)',
  'Zealand University Hospital (SUH)', 'Steno Diabetes Center Copenhagen (SDCC)',
  'Steno Diabetes Center Aarhus (SDCA)', 'Statens Serum Institut (SSI)',
  'Niels Bohr Institute (NBI)', 'Royal Danish Academy of Sciences and Letters (RDAS)',
  'Danish Meteorological Institute (DMI)', 'Geological Survey of Denmark and Greenland (GEUS)',
  'Alexandra Institute (Alexandra)', 'Danish Technological Institute (DTI)',
  'Novo Nordisk Foundation Center for Protein Research (CPR)',
  'Novo Nordisk Foundation Center for Basic Metabolic Research (CBMR)',
  'Novo Nordisk Foundation Center for Stem Cell Medicine (reNEW) (reNEW)',
  'Interdisciplinary Nanoscience Center (iNANO)',
  'DTU Space – National Space Institute (DTU Space)',
  'Danish Institute for International Studies (DIIS)',
  'VIVE – The Danish Center for Social Science Research (VIVE)',
  'Danish Institute for Advanced Study (D-IAS)',
  'Novo Nordisk Foundation Center for Biosustainability (DTU Biosustain)',
  'National Institute of Public Health (SIF)', 'Aarhus Institute of Advanced Studies (AIAS)',
  'Pioneer Centre for Artificial Intelligence (P1)',
  'Rockwool Foundation Research Unit (RFF Research Unit)', 'BioInnovation Institute (BII)',
  'Novo Nordisk Foundation (Novo Nordisk Fonden)', 'Lundbeck Foundation (Lundbeckfonden)',
  'Carlsberg Foundation (Carlsbergfondet)', 'Villum Foundation (Villum Fonden)',
  'Danish Cancer Society (Kræftens Bekæmpelse)', 'Danish National Research Foundation (DNRF)',
];
...
async function callClaude(existing) {
  ...
  const prompt = `You are researching OpenAlex (the open scholarly metadata index run by OurResearch) subscription status for Denmark research institutions, for a sales-intelligence CRM used by a competing publisher.
...
2. Any Danish university, medical centre, or research institute NOT in the list above that has confirmed an OpenAlex subscription.
...
async function main() {
  ...
  console.log(`[openalex-subscription-scan] Calling Claude with web search across ${DK_INSTITUTIONS.length} tracked institutions...`);
